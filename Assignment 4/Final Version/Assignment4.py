...
def read_player_moves():
    ...
    if "\n" in playerMoves1:  # Check if the file contains a newline character
    ...
    errors = {"IndexError":"X", "ValueError":"V", "AssertionError":"Z"}  # A dictionary to store the error messages and the corresponding error codes
    ...
    for element in playerMoves1:
        try:
            ...
            playerMoves1[playerMoves1.index(element)] = 'X' + element  # If the length is not 3 or 4, replace the element with the corresponding error code
            continue  # Continue to the next element
        except IndexError:
            playerMoves1[playerMoves1.index(element)] = 'X' + element  
            continue
        ...
        try:
            ...
            playerMoves1[playerMoves1.index(element)] = 'Z' + element  # If the first character is not a number between 1 and 10 or the second character is not a letter between A and J, replace the element with the corresponding error code
            continue
        except ValueError:
            playerMoves1[playerMoves1.index(element)] = 'V' + element  # If the first character is not a number, replace the element with the corresponding error code
            continue
        except IndexError:
            playerMoves1[playerMoves1.index(element)] = 'X' + element  # If the element is empty, replace the element with the corresponding error code
            continue    
    ...
    for element in playerMoves2:
        try:
            ...
            playerMoves2[playerMoves2.index(element)] = 'X' + element
            continue
        except IndexError:
            playerMoves2[playerMoves2.index(element)] = 'X' + element
            continue
        ...
        try:
            ...
            playerMoves2[playerMoves2.index(element)] = 'Z' + element
            continue
        except ValueError:
            playerMoves2[playerMoves2.index(element)] = 'V' + element
            continue
        except IndexError:
            playerMoves2[playerMoves2.index(element)] = 'X' + element
            continue
...
def playTurn(player):
    ...
    try:  # Try to get the player's move
        ...
        sys.exit()
    if move[0] == 'X' or move[0] == 'V' or move[0] == 'Z':
        print("Enter your move: {}".format(move[1:]))
        write_output_file("Enter your move: {}\n".format(move[1:]))
    else:
        print("Enter your move: {}\n".format(move))  # Print the player's move 
        write_output_file("Enter your move: {}\n\n".format(move))
    while move[0] == 'X':  # If the player's move is invalid
        print("IndexError: Invalid move. Please enter a valid move.")
        write_output_file("IndexError: Invalid move. Please enter a valid move.\n")
        players_move.remove(move)  # Remove the invalid move from the players_move list
        move = players_move[gameturn-1]  # Set the move variable to the player's move
        if move[0] == 'X' or move[0] == 'V' or move[0] == 'Z':
            print("Enter your move: {}".format(move[1:]))
            write_output_file("Enter your move: {}\n".format(move[1:]))
            ...
            print("Enter your move: {}\n".format(move))
            write_output_file("Enter your move: {}\n\n".format(move))
    while move[0] == 'V':  # If the player's move is invalid
        print("ValueError: Invalid move. Please enter a valid move.")
        write_output_file("ValueError: Invalid move. Please enter a valid move.\n")
        players_move.remove(move)  # Remove the invalid move from the players_move list
        move = players_move[gameturn-1]  # Set the move variable to the player's move
        if move[0] == 'X' or move[0] == 'V' or move[0] == 'Z':
            print("Enter your move: {}".format(move[1:]))
            ...
            print("Enter your move: {}\n".format(move))
            write_output_file("Enter your move: {}\n\n".format(move))
    while move[0] == 'Z':  # If the player's move is invalid
        print("AssertionError: Invalid move. Please enter a valid move.")
        write_output_file("AssertionError: Invalid move. Please enter a valid move.\n")
        players_move.remove(move)  # Remove the invalid move from the players_move list
        move = players_move[gameturn-1]  # Set the move variable to the player's move
        if move[0] == 'X' or move[0] == 'V' or move[0] == 'Z':
            print("Enter your move: {}".format(move[1:]))
